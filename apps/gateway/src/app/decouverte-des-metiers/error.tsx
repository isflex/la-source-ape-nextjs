...
export default function DecouverteDesMetiersError({ error, reset }: ErrorProps) {
  ...
  React.useEffect(() => {
    ...
    debug.errorBoundary('[DecouverteDesMetiers Error]', {
      name: error.name,
      ...
      <InfoBlock>
        ...
        <InfoBlockContent>
          <Title level={TitleLevel.LEVEL4}>
            {`Nous sommes désolés, la page Découverte des métiers ne peut pas être chargée.`}
          </Title>
