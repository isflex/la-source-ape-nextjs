...
export default function PiscineCreerError({ error, reset }: ErrorProps) {
  ...
  React.useEffect(() => {
    ...
    logClientError({
      ...
      route: '/planning/piscine/creer/',
      userAgent: typeof navigator !== 'undefined' ? navigator.userAgent : undefined
    })

    // Log to console for debugging
    debug.errorBoundary('[PiscineCreer Error]', {
      name: error.name,
      ...
      <InfoBlock>
        ...
        <InfoBlockContent>
          <Title level={TitleLevel.LEVEL4}>
            {`Nous sommes désolés, la page Planning Piscine ne peut pas être chargée.`}
          </Title>
