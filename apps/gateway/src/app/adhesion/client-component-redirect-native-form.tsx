          ...
          <InfoBlock>
            ...
            <InfoBlockContent>
              ...
              <div style={{ marginTop: '1.5rem' }}>
                ...
                >
                  <div className="HaPay">
                    <button className="HaPayButton">
                      <img src="/assets/svg/helloasso/logo-ha.svg" alt="" className="HaPayButtonLogo" />
                      <div className="HaPayButtonLabel">
                        <span> Adhérer via HelloAsso </span>
                    ...
                    <div className="HaPaySecured">
                      ...
                      <img src="/assets/svg/helloasso/logo-visa.svg"
                        alt="Logo Visa" />
                      <img src="/assets/svg/helloasso/logo-mastercard.svg"
                        alt="Logo Mastercard" />
                      <img src="/assets/svg/helloasso/logo-cb.svg"
                        alt="Logo CB" />
                      <img src="/assets/svg/helloasso/logo-pci.svg"
                        alt="Logo PCI" />
                    </div>
                  </div>
                </Button>
