...
export const metadata: Metadata = buildMetadata({
  title: "À propos",
  description: `Promouvoir ${process.env.NEXT_PUBLIC_PARENT_ASSOCIATION_GENERIC} de ${process.env.NEXT_PUBLIC_SCHOOL_TITLE_GENERIC} — missions d'équipe et site conçu par l'agence web Flexiness.`,
  path: "/about",
});
  ...
  return (
    ...
    >
      ...
      >
        ...
        <section
          className={classNames(
            stylesPage.sectionAbout,
            flexStyles.isFullwidth,
            !mobileCheck &&
              `showSpagehetti__${process.env.NEXT_PUBLIC_BUILD_ID}`,
          )}
        >
          {children}
        </section>
