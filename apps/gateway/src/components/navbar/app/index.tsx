        ...
        >
          ...
          >
            <Title
              ...
              className={classNames("my-0 ml-0 mr-4")}
            >
              Menu
            </Title>
            <Icon
              ...
              className={classNames(
                activeDropdown ? "rotate-180" : "rotate-none",
              )}
            />
          </div>
        </Button>
          ...
          .map(([key, value], index) => {
            ...
            return (
              <span key={index} className={stylesPage.navItem}>
                <Text className={classNames(flexStyles.isInline)}>
                  {value.emoji}
                </Text>
                {!mobileCheck && (
                  <span
                    ...
                    className={classNames(
                      ...
                      flexStyles.isHiddenMenuIconTabletToDesktop,
                    )}
                  >
                    {"\u00A0 > \u00A0"}
                  </span>
                )}
                <Link href={href} className={classNames(flexStyles.link)}>
                  {value.navTitle}
                </Link>
              </span>
            );
