        ...
        <main className={classNames(flexStyles.fullPage, flexStyles.hasSpaceBetweenContent)}>
          <section className={classNames(
            ...
            <InfoBlock>
              ...
              <InfoBlockContent>
                <Title level={TitleLevel.LEVEL4}>{`Cette page utilise une instance Spot Amazon EC2 pour faire fonctionner le server du Web App`}</Title>
                ...
                <Title level={TitleLevel.LEVEL6}>
                  {`
                    ...
                    Dès que la capacité sera suffisante, notre instance redémarrera et le Web App sera à nouveau disponible.
                  `}
                </Title>
