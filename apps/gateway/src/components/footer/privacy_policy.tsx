        ...
        <Box>
          ...
          <BoxContent>
                ...
                <TableTr>
                  <TableTd colSpan={2}>
                    <Icon
                      content={
                        <Text>
                          Cela nous permet de vous authentifier via Google, puis
                          de partager vos coordonnées de contacte avec
                          d&apos;autres utilisateurs authentifiés à
                          l&apos;application.
                        </Text>
                      }
                      size={IconSize.SMALL}
            ...
            <Text>
              ...
              modifiant les paramètres de votre compte Google utilisé pour vous
              authentifier sur notre application.
            </Text>
            <Text>
            ...
            <Text>
              Nous mettons en œuvre des protocoles de sécurité robustes pour
              protéger vos données, incluant chiffrement et contrôle
              d&apos;accès restreint.
            </Text>
            ...
            <Text>
              Nous exploitons un groupe de discussion WhatsApp à travers lequel
              les utilisateurs peuvent interagir avec nos services. Ce canal de
              communication est alimenté par un assistant (agent) basé sur
              l&apos;intelligence artificielle, capable de répondre à vos
              messages, de fournir des informations et de vous assister dans vos
              demandes.
            </Text>
            <Box
              className={classNames(
            ...
            <Text>
              Meta agit en tant que sous-traitant pour la livraison des messages
              WhatsApp en notre nom. Meta est certifié dans le cadre du Cadre de
              Protection des Données UE-États-Unis (DPF), qui constitue la base
              juridique pour tout transfert de données vers les États-Unis
              pouvant intervenir dans le cadre de l&apos;infrastructure de
              messagerie.
            </Text>
            <Text>
              Pour plus de détails sur le traitement des données par Meta,
              veuillez consulter :<br />
              <Link href="https://www.whatsapp.com/legal/business-data-processing-terms">
            ...
            <Table bordered>
              <TableHead>
                <TableTr>
                  <TableTh>
                    <Text className={flexStyles.hasTextWeightBold}>
                  ...
                  <TableTh className={flexStyles.isHiddenMobile}>
                    <Text className={flexStyles.hasTextWeightBold}>Source</Text>
                  </TableTh>
                </TableTr>
              </TableHead>
              <TableBody>
            ...
            <Table bordered>
              <TableHead>
                <TableTr>
                  ...
                  <TableTh>
                    <Text className={flexStyles.hasTextWeightBold}>Détail</Text>
                  </TableTh>
                </TableTr>
              </TableHead>
              <TableBody>
            ...
            <Text>
              Notre agent IA fournit uniquement des réponses informatives et une
              assistance. Il ne prend pas de décisions automatisées produisant
              des effets juridiques ou vous affectant de manière significative
              de façon similaire. En cas de modification de cette pratique, nous
              mettrons à jour la présente politique et obtiendrons votre
              consentement explicite lorsque cela est requis.
            </Text>
            <Divider />
            ...
            <Table bordered>
              <TableHead>
                <TableTr>
                  ...
                  <TableTh>
                    <Text className={flexStyles.hasTextWeightBold}>Rôle</Text>
                  </TableTh>
                  <TableTh className={flexStyles.isHiddenMobile}>
                    <Text className={flexStyles.hasTextWeightBold}>
                      Localisation
            ...
            <Text>
              Nous avons conclu des Accords de Traitement des Données (DPA)
              conformément à l&apos;Article 28 du RGPD avec chacun des
              sous-traitants mentionnés ci-dessus. Ces accords garantissent la
            ...
            <Text>
              En rejoignant notre groupe WhatsApp et en interagissant avec
              l&apos;agent IA, vous consentez au traitement de vos données
              personnelles tel que décrit dans la présente politique. Avant
              votre première interaction, vous recevrez un message
              d&apos;accueil identifiant clairement la nature artificielle de
              l&apos;agent et contenant un lien vers la présente politique de
              confidentialité.
            </Text>
            ...
            <Text>
              ...
              données conformément à notre politique de conservation, sauf si la
            ...
            <Text>
              Conformément aux principes de minimisation des données (Art. 5
              RGPD) et au Règlement européen sur l&apos;IA, nous avons mis en
            ...
            <Text>
              Vous avez le droit d&apos;introduire une réclamation auprès
              d&apos;une autorité de contrôle si vous estimez que le traitement
            ...
            <Text>
              ...
              temps à autre. En cas de modifications substantielles, nous vous
              en informerons via le groupe de discussion WhatsApp et/ou sur
              notre site internet. La date de la dernière révision est indiquée
              ci-dessous.
            </Text>
            <Text>
