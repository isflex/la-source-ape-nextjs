        ...
        <Box>
          ...
          <BoxContent>
            <div className={classNames(flexStyles.isFullwidth, flexStyles.isFlex, flexStyles.isFlexDirectionColumn, flexStyles.isAlignItemsCenter, flexStyles.isJustifiedCenter)}
              ...
              <Title level={TitleLevel.LEVEL5} className={flexStyles.isMarginless}>{`${process.env.NEXT_PUBLIC_APP_TITLE}`}</Title>
            </div>
            ...
            <Box className={classNames(flexStyles.isPaddingless, flexStyles.isFlat, flexStyles.isFlatFlexPurple, flexStyles.isGreyDark)}>
              <Section>
                ...
                <Text>
                  Vous comprenez que l&apos;application <strong>{`${process.env.NEXT_PUBLIC_APP_TITLE}`}</strong> a pour vocation de servir de forum d&apos;annonces plus ou moins ouvert à tous.
