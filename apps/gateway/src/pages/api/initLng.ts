...
//   })
//   // //Read the txt data file initLng.txt
//   const txtFileContents = await fs.readFile(path.resolve(__dirname, '../../../initLng.txt'), 'utf8')
//   // // eslint-disable-next-line no-console
//   // console.log(txtFileContents.replace(/^\n|\n$/g, ''))
//   // //Return the content of the data file in json format
//   res.status(200).json({ initLng: txtFileContents.replace(/^\n|\n$/g, '') })

//   // //Read the json data file initLng.json
//   // const jsonFileContents = await fs.readFile(path.resolve(__dirname, '../initLng.json'), 'utf8');
//   // //Return the content of the data file in json format
