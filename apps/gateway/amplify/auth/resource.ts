...
//         `${process.env.FLEX_PROTOCOL as string}${process.env.FLEX_FUTUR_PROOF_DOMAIN_NAME_1 as string}/`,
//         `${process.env.FLEX_PROTOCOL as string}${process.env.FLEX_FUTUR_PROOF_DOMAIN_NAME_2 as string}/`,
...
//         `${process.env.FLEX_PROTOCOL as string}${process.env.FLEX_FUTUR_PROOF_DOMAIN_NAME_1 as string}:${process.env.FLEX_PROXY_PORT as string}/`,
//         `${process.env.FLEX_PROTOCOL as string}${process.env.FLEX_FUTUR_PROOF_DOMAIN_NAME_2 as string}:${process.env.FLEX_PROXY_PORT as string}/`,
