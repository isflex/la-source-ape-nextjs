...
import { PriceProps } from './PriceProps.js'
 ...
 */
const Price = ({ className, variant, amount, mention, period, showCents, level, huge, inverted, ...others }: PriceProps): React.JSX.Element => {
